...
const assertions = {
  ...
  exactlyOneSuccessfulTaskLifecycle:
    ...
    typeof task.ended_at === "number" &&
    task.ended_at > 0,
  exactlyOneTerminalDelivery:
    fallbackVerdict.actualTerminalSendCount === 1 &&
    fallbackVerdict.capturedTerminalPayloads?.length === 1 &&
    fallbackVerdict.capturedTerminalPayloads[0] === "QA-SUBAGENT-TERMINAL-FALLBACK-OK",
  internalMetadataRedacted: fallbackVerdict.internalMetadataLeak === false,
};
